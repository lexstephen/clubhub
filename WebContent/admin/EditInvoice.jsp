	...
	<form action="${pageContext.request.contextPath}/InvoiceController" method="post" class="form" role="form">
		...
		<div class="row">
			...
			<div class="col-xs-7">
				<div class="form-group <c:if test="${!empty errorInvDate}">has-error</c:if>">
			    	<input type="date" name="invDate" class="form-control" id="inptInvDate" value="${invoice.invDate}">
			  	</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-2 <c:if test="${!empty errorCharge01Qty}">has-error</c:if>">
				<input type="text" name="charge01qty" class="form-control qty" id="inptCharge01qty" value="${(invoice.charge01qty > 0)? invoice.charge01qty:'0'}">
			</div>
			<div class="col-xs-2">
		...
		<div class="row">
			...
			<div class="col-xs-2 <c:if test="${!empty errorCharge02Qty}">has-error</c:if>">
				<input type="text" name="charge02qty" class="form-control qty" id="inptCharge02qty" value="${(invoice.charge02qty > 0)? invoice.charge02qty:'0'}">
			</div>
			<div class="col-xs-2">
		...
		<div class="row">
			...
			<div class="col-xs-2 <c:if test="${!empty errorCharge03Qty}">has-error</c:if>">
				<input type="text" name="charge03qty" class="form-control qty" id="inptCharge03qty" value="${(invoice.charge03qty > 0)? invoice.charge03qty:'0'}">
			</div>
			<div class="col-xs-2">
		...
		<div class="row">
			...
			<div class="col-xs-2 <c:if test="${!empty errorCharge04Qty}">has-error</c:if>">
				<input type="text" name="charge04qty" class="form-control qty" id="inptCharge04qty" value="${(invoice.charge04qty > 0)? invoice.charge04qty:'0'}">
			</div>
			<div class="col-xs-2">
		...
		<div class="row">
			...
			<div class="col-xs-2 <c:if test="${!empty errorCharge05Qty}">has-error</c:if>">
				<input type="text" name="charge05qty" class="form-control qty" id="inptCharge05qty" value="${(invoice.charge05qty > 0)? invoice.charge05qty:'0'}">
			</div>
			<div class="col-xs-2">
		...
		<div class="row">
			...
			<div class="col-xs-10">
				<div class="radio">
			    	...
			    	<label class="checkbox-inline">
			      		<input type="radio" name="status" id="inptStatusP" value="paid"  ${invoice.status == 'paid' ? 'checked' : ''}> Paid
			      	</label>
			  	</div>
			</div>
		</div>
