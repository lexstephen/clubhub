...
<form action="${pageContext.request.contextPath}/PreferenceController"
	...
	<c:forEach items="${colour_schemes}" var="colour_scheme" varStatus="status"> 
		...
		<div class="row">
			<div class="col-sm-12">
				<p>Use this section to customize your ClubHub installation's
					public frontend to suit your club.</p>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="row">
							<label class="col-sm-4 control-label"> Active Preference:
							</label>
							<div class="col-sm-8">
								<em><span id="activePrefId" class="hidden">${preference.id }</span>
									${preference.preference_name }</em> [<a href="#" id="loadPref">load</a>]
								[<a href="SetPreferences.jsp">change default</a>]
							</div>
						</div>
					</div>
					<div class="col-sm-6">
		...
		<div
			class="row form-group <c:if test="${!empty errorClub_Name_Long}">has-error</c:if>">
			<h3>Club Settings</h3>
		...
		<div
			class="row form-group <c:if test="${!empty errorClubURL}">has-error</c:if>">
			...
			<div class="col-xs-6">
				<div
					...
					<label for="inptPostalCode" id="lblPostalCode"
						${country == 'United States of America' ? ' class="hiddenest"' : ''}>
			...
			<div class="col-xs-6">
				<div
					...
					<label for="inptCountry">Country</label> <select name="country"
						...
						<option ${country == 'United States of America' ? 'selected' : ''}>United
			...
			<div class="col-xs-6">
				<div
					...
					<label for="inptProvince" id="lblProvince"
						...
						${country == 'Canada' ? ' class="hiddenest"' : ''}
						${country == null ? ' class="hiddenest"' : ''}> State </label> <select
						name="province"
						class="form-control ${country == 'United States of America' ? ' hiddenest' : ''}"
						id="inptProvince">
						...
						class="form-control ${country == 'Canada' ? ' hiddenest' : ''} ${country == null ? ' hiddenest' : ''}"
						id="inptState">
		...
		<div class="row">
			<div class="col-sm-12">
				<h3>Colour Scheme</h3>
				<p>
					Choose from a predefined scheme. Colour Schemes can be <a
						href="${pageContext.request.contextPath}/admin/ColourSchemes.jsp">edited
						here</a>.
				</p>

				<div class="row">
					<label class="col-sm-3 control-label"> Colour Scheme </label>
					<div class="col-sm-9">
						...
						<div class="row">
							<div class="col-xs-3" id="preview_Dark_colour">
								<br>
								<br>
							</div>
							<div class="col-xs-3" id="preview_Med_colour">
								<br>
								<br>
							</div>
							<div class="col-xs-3" id="preview_Light_colour">
								<br>
								<br>
							</div>
							<div class="col-xs-3" id="preview_Text_colour">
								<br>
								<br>
							</div>
						</div>
		...
		<div class="row form-group">
			<label class="col-sm-3 control-label"> Small Website Logo </label>
			<div class="col-sm-8">
...
<div class="col-md-8 col-xs-12 form-group">
	<form action="${pageContext.request.contextPath}/PreferenceController"
		method="post">
		<input id="inpt_delete" type="hidden" name="prefID"
			value="${preference.id}"> <input type="hidden" name="option"
			value="delete"> <input class="btn btn-danger" type="submit"
			value="Delete"> <label>Warning! Deletion cannot be
			undone.</label>
	</form>
</div>
</div>
