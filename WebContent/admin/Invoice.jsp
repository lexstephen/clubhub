	...
	<div class="col-xs-7">
		<div class="form-group">
			<input type="date" name="invDate" class="form-control"
				id="inptInvDate" value="${invoice.invDate}" readonly>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-xs-2">
		<div class="form-group">
			<input type="text" name="taxes" id="taxes" class="form-control taxes"
				readonly value="${invoice.taxes }">
		</div>
	</div>
</div>
	...
	<div class="col-xs-10">
		<div class="radio">
			<label class="checkbox-inline"> <input type="radio"
				...
				${invoice.status == 'unpaid' ? 'checked' : ''} disabled>
				Unpaid
			</label> <label class="checkbox-inline"> <input type="radio"
				name="status" id="inptStatusP" value="paid"
				${invoice.status == 'paid' ? 'checked' : ''} disabled> Paid
			</label>
		</div>
	</div>
</div>
