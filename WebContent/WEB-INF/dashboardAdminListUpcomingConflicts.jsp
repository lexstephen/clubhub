	...
	<tbody>
		...
		<tr>
			<td class="col-xs-12 col-md-3 control-label"><a
				href="${pageContext.request.contextPath}/admin/EditGame.jsp?gameID=${game.gameid}">14</a></td>
			<td class="col-xs-12 col-md-2">2016-03-02</td>
		</tr>

		<tr>
			<td class="col-xs-12 col-md-3 control-label"><a
				href="${pageContext.request.contextPath}/admin/EditGame.jsp?gameID=${game.gameid}">15</a></td>
			<td class="col-xs-12 col-md-2">2016-03-09</td>
		</tr>

		<tr>
			<td class="col-xs-12 col-md-3 control-label"><a
				href="${pageContext.request.contextPath}/admin/EditGame.jsp?gameID=${game.gameid}">17</a></td>
