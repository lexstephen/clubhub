...
<!-- end of main div class row -->
<div class="row">
	<div class="col-md-9 col-xs-12 ">
		<address>
			<strong>${preference.club_name_long }</strong> | ${preference.address },
	...
	<div class="col-md-3 col-xs-12 ">
		<img class="center-block"
			src="${pageContext.request.contextPath}/images/ch_logo.png">
	</div>
</div>
</div>
<!--  end of main div class container -->
...
<script type="text/javascript"
	...
	charset="utf-8"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/fileinput.min.js"
	charset="utf-8"></script>
</body>
</html>
