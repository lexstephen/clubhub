	...
	<div class="container">
		<div class="navbar-header">
			<a href="${pageContext.request.contextPath}/Main.jsp"
				class="pull-left"><img
				src="${pageContext.request.contextPath}/ImageDao?t=image_small_logo"></a>
			...
			<ul class="nav navbar-nav justified">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					<ul class="dropdown-menu">
						...
						<c:if test="${(isAdmin == true)}">
							<li><a
								href="${pageContext.request.contextPath}/Register.jsp">Add
									New User</a></li>
						</c:if>
					</ul></li>
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false">Invoices <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a
				...
				<c:if test="${isLoggedIn == true}">
					<li><a
						href="${pageContext.request.contextPath}/Profile.jsp?userID=${loggedInUserID }">Logged
							in as ${loggedInUserFullName }</a></li>
					<li><img
						src="${pageContext.request.contextPath}/ImageDao?t=profile&id=${loggedInUserID }"
