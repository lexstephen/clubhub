		...
		<script type="text/javascript" src="/clubhub/js/invoice.js" charset="utf-8"></script>
		<script type="text/javascript" src="/clubhub/js/colourscheme.js" charset="utf-8"></script>
	</body>
</html>