...
/* **************** dark colour ******************* */
hr {
	border-top: 1px${colour_scheme.med_colour
}
...
.frontend h1, .frontend h2 {
	border-bottom: 1px${colour_scheme.dark_colour
}
...
.frontend .navbar-nav>li>a:hover, .frontend .navbar-nav>li>a:focus {
