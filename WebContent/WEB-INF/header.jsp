...
<body>
	...
	<div class="container">
		<div class="navbar-header">
			<a href="#" class="pull-left"><img src="images/rcc.png"
				id="rcc_circle_logo"></a> <a class="navbar-brand" href="Home">Message
				Board</a>
		</div>
		...
		<div class="collapse navbar-collapse navbar-right">
			<c:choose>
				...
				<c:otherwise>
					<p class="navbar-text navbar-right">
						<a href="/comp3095/assignment2/Logout" class="navbar-link">${sessionScope.userName }</a><span
							class="caret"></span>
					</p>
				</c:otherwise>
			</c:choose>
