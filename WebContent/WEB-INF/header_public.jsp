...
<body class="frontend">
	<nav class="navbar navbar-static-top navbar-inverse sidebar"
		role="navigation">
	<div class="container">
		<div class="navbar-header">
			<a href="${pageContext.request.contextPath}/Main.jsp"
				class="pull-left"><img
				src="${pageContext.request.contextPath}/ImageDao?t=image_logo"
				id="rcc_circle_logo"></a>
		...
		<div class="collapse navbar-collapse navbar-right">
			<form action="${pageContext.request.contextPath}/PostController"
				method="post" class="form-inline clearfix pushdown">
				<div class="form-group">
					<input type="text" class="form-control" name="searchTerm"
						placeholder="search updates" onfocus="this.placeholder = ''"
						onblur="this.placeholder = 'search updates'"> <input
						type="submit" class="btn btn-primary btn-xs" name="option"
						value="search">
				</div>
			</form>
		</div>
		<div id="navbar" class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav">
				...
				<c:forEach items="${posts}" var="post">
					<li><a
						href="${pageContext.request.contextPath}/Static.jsp?postID=${post.id}">${post.title}</a></li>
				</c:forEach>
				<c:choose>
					<c:when test="${isLoggedIn == true}">
						<li><a href="${pageContext.request.contextPath}/admin/">Dashboard
								[${loggedInUserFullName }]</a></li>
