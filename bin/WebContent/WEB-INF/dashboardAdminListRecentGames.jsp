	...
	<tbody>
		...
		<tr>
			<td class="col-xs-12 col-md-3 control-label"><a
				href="/clubhub/admin/EditGame.jsp?gameID=${game.gameid}">4</a></td>
		...
		<tr>
			<td class="col-xs-12 col-md-3 control-label"><a
				href="/clubhub/admin/EditGame.jsp?gameID=${game.gameid}">3</a></td>
		...
		<tr>
			<td class="col-xs-12 col-md-3 control-label"><a
				href="/clubhub/admin/EditGame.jsp?gameID=${game.gameid}">2</a></td>
