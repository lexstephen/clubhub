...
<div class="row">
	<div class="col-xs-2 col-xs-offset-6">View another profile:</div>
	<div class="col-xs-3">
...
<div class="row">
	...
	<div class="col-xs-6 col-xs-offset-1 jumbotron vertical-center">
		...
		<c:if test="${(isAdmin == true) || user.userid == loggedInUserID}">
			...
			<p>
				<small>Birthday: ${user.dateOfBirth }</small>
			</p>
			<p>
			...
			<span class="expand"> <a
				href="/clubhub/admin/EditProfile.jsp?userID=${user.userid}"
