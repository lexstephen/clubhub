...
<form action="/clubhub/PreferenceController" method="post" class="form"
	...
	Schemes.push(SchemeObj);
		...
		<div class="row">
			<div class="col-sm-12">
				<p>Use this section to customize your ClubHub installation to
					suit your club.</p>
				<p>Edit a pre-existing Preference by selecting it from the drop
					down list, or select 'Add New' to enter a new one.</p>

				<div class="row">
					<div class="col-sm-7 col-sm-offset-5">
						<select name="prefid" class="form-control" id="inptPrefID">
							<option value="000" ${preference.id == '000' ? 'selected' : ''}>--
								Add New --</option>
							<c:forEach items="${prefs}" var="preference">
								<option value="${preference.id}"
									${preferenceID == preference.id ? 'selected' : ''}>${preference.preference_name}</option>
							</c:forEach>
						</select>
					</div>
				</div>
			...
			<div class="col-sm-9">
				<div
					...
					<select name="country" class="form-control" id="inptCountry">
						...
						<option
							${preference.country == 'United States of America' ? 'selected' : ''}>United
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="row">
					<label class="col-sm-4 control-label"> Colour Scheme </label>
					<div class="col-sm-8">
						<div
							class="form-group <c:if test="${!empty errorCountry}">has-error</c:if>">
							<select name="colour_schemeid" class="form-control"
								id="inptSchemeID">
								<c:forEach items="${colour_schemes}" var="colour_scheme">
									<option value="${colour_scheme.id}"
										${colour_schemeid == colour_scheme.id ? 'selected' : ''}>${colour_scheme.name}</option>
								</c:forEach>
							</select>
						</div>
						<div class="row">
		...
		<div class="row">
			<h3>Images</h3>
			<label class="col-sm-4 control-label"> Website Logo </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file" name="image_logo"
					id="image_logo">
			</div>
		...
		<div class="row">
			<label class="col-sm-4 control-label"> Small Website Logo </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file" name="image_small_logo"
					id="image_small_logo">
			</div>
		...
		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 01 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_01">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_1">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 02 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_02">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_2">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 03 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_03">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_3">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 04 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_04">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_4">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 05 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_05">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_5">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 06 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_06">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_6">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 07 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_07">
			</div>
			<div class="col-sm-2" prev_image id="display_featured_image_7">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 08 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_08">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_8">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 09 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_09">
			</div>
			<div class="col-sm-2 prev_image" id="display_featured_image_9">&nbsp;</div>
		</div>

		<div class="row">
			<label class="col-sm-4 control-label"> Featured Image 10 </label>
			<div class="col-sm-6">
				<input class="form-control file" type="file"
					name="featured_image_10">
			</div>
			...
			<div class="col-xs-9">
				<div class="radio">
					<label class="checkbox-inline"> <input type="radio"
						name="status" id="inptStatusActive" checked value="1"
						${status == '1' ? 'checked' : ''}> Active
					</label> <label class="checkbox-inline"> <input type="radio"
						name="status" id="inptStatusInactive" value="0"
