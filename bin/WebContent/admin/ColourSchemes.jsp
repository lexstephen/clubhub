...
<form action="/clubhub/ColourSchemeController" method="post"
	...
	<div class="form-group ColourSchemes">
		...
		<div class="row">
			<div class="col-xs-7 col-sm-offset-5 control-label">
				<p>
					Please enter 3 or 6 digit hexadecimal codes <i>without</i> the
					octothrope (#) for the following colour fields:
				</p>
			</div>
		</div>
		...
		<div class="row">
			<label class="col-sm-3 col-sm-offset-2 control-label form-group">
				Dark Colour
				<p class="help-block">Dark Colour is used for navbar, page
					headings and links.</p>
			</label>
			<div class="col-sm-7 form-group preview_colour"
				id="preview_Dark_colour">
				<div class="row">
					<div class="col-sm-6">
						<input class="form-control hex_code" type="text"
							name="dark_colour" id="schemeDark_colour" value="">
					</div>
		...
		<div class="row">
			<label class="col-sm-3 col-sm-offset-2 control-label form-group">
				Medium Colour
				<p class="help-block">Used as a background for hovered links in
					the navbar.</p>
			</label>
			<div class="col-sm-7 form-group preview_colour"
				...
				<div class="row">
					<div class="col-sm-6">
						<input class="form-control hex_code" type="text" name="med_colour"
							id="schemeMed_colour" value="">
					</div>
					<div class="col-sm-6">&nbsp;</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-7 form-group preview_colour"
				...
				<div class="row">
					<div class="col-sm-6">
						<input class="form-control hex_code" type="text"
							name="light_colour" id="schemeLight_colour" value="">
					</div>
					<div class="col-sm-6">&nbsp;</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-7 form-group preview_colour"
				...
				<div class="row">
					<div class="col-sm-6">
						<input class="form-control hex_code" type="text"
							name="text_colour" id="schemeText_colour" value="">
					</div>
					<div class="col-sm-6">&nbsp;</div>
				</div>
			</div>
